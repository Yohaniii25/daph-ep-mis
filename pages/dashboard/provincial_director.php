...
<div id="layoutSidenav_content">
    <main class="container-fluid px-4">
        <h2 class="mt-4 mb-5 text-danger fw-normal">Provincial Director Dashboard</h2>
        ...
        <div class="row g-4 mb-5">
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Total Development Projects</h6>
                        <h2 class="text-primary mb-2">24</h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Total Animals Treated</h6>
                        <h2 class="text-danger mb-2">2150 <small class="text-muted">Animals</small></h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Vehicle Requests Processed</h6>
                        <h2 class="text-warning mb-2">320</h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Officers Active</h6>
                        <h2 class="text-success mb-2">12</h2>
