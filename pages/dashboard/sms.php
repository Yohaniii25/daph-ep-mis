...
<div id="layoutSidenav_content">
    <main class="container-fluid px-4">
        <h2 class="mt-4 mb-5 text-black fw-normal">Subject Matter Specialist Dashboard</h2>
        ...
        <div class="row g-4 mb-5">
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Tasks Today</h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Disease Alerts</h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Supply Stock Alerts</h6>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="text-muted mb-3">Reports Pending</h6>
                        <h2 class="text-success mb-2">03</h2>
