            ...
            <form action="processors/office_assets_crud.php" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="specification" class="form-control" rows="2" placeholder="e.g. Brand, Model, Serial, Horsepower..."></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Remarks / Location</label>
                        <textarea name="remarks" class="form-control" rows="2" placeholder="Shed location, service history..."></textarea>
                    </div>
                </div>
