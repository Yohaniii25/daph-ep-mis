...
if ($action === 'save_counterfoil') {
    ...
    $stmt = $mysqli->prepare("INSERT INTO counterfoil_assets (user_id, training_center_id, user_category, district_id, range_id, counterfoil_type, book_serial_no, page_count, available_quantity, initial_count, received_quantity, purchase_date, current_condition, remarks, issue_order_no, received_from, receipt_no, specification, issued_to, date_of_issue, date_of_return) VALUES (?, ?, ?, ?, 0, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("iisisssiiissssssssss", $user_id, $training_center_id, $user_category, $district_id, $counterfoil_type, $book_serial_no, $page_count, $available_quantity, $initial_count, $received_quantity, $purchase_date, $current_condition, $remarks, $issue_order_no, $received_from, $receipt_no, $specification, $issued_to, $date_of_issue, $date_of_return);
...
if ($action === 'update_counterfoil') {
    ...
    $stmt = $mysqli->prepare("UPDATE counterfoil_assets SET counterfoil_type = ?, book_serial_no = ?, page_count = ?, available_quantity = ?, initial_count = ?, received_quantity = ?, purchase_date = ?, current_condition = ?, remarks = ?, issue_order_no = ?, received_from = ?, receipt_no = ?, specification = ?, issued_to = ?, date_of_issue = ?, date_of_return = ? WHERE id = ? AND (training_center_id = ? OR user_id = ?)");
    $stmt->bind_param("sssiiissssssssssiii", $counterfoil_type, $book_serial_no, $page_count, $available_quantity, $initial_count, $received_quantity, $purchase_date, $current_condition, $remarks, $issue_order_no, $received_from, $receipt_no, $specification, $issued_to, $date_of_issue, $date_of_return, $id, $training_center_id, $user_id);
