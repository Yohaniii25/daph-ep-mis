<!-- Modal 3: View Officer Details Modal -->
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header text-light" style="background-color: #370709;">
                <h5 class="modal-title fw-bold"><i class="bi bi-person-badge me-2"></i>Officer Full Profile</h5>
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <span class="fw-bold text-dark fs-6" id="view_full_name">-</span>
                    </div>
                    <div class="col-md-6">
                        <small class="text-muted d-block text-uppercase fw-semibold" style="font-size:11px;">Service Number</small>
                        <span class="fw-bold text-primary" id="view_service_number">-</span>
                    </div>
                    <div class="col-md-6">
