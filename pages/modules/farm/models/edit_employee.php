                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="employment_type" id="edit_emp_employment_type" class="form-select fw-bold" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date_of_birth" id="edit_emp_date_of_birth" class="form-control">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="position_to_current_location" id="edit_emp_position_to_current_location" class="form-control">
                        </div>
                    </div>
                </div>
