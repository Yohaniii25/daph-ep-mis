    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="processors/chicks_issuing_crud.php" method="POST">
                ...
                <div class="modal-header text-light" style="background-color: #8d170e;">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-bold">Reporting Month <span style="color: #370709;">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-bold">Batch No. <span style="color: #370709;">*</span></label>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="no_of_eggs_hatched" id="add_no_of_eggs_hatched" class="form-control" min="0" value="0">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-bold" style="color: #370709;">Deaths Before Sexing</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="live_chicks_pullets" id="add_live_chicks_pullets" class="form-control border-primary" min="0" value="0">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold text-primary">Live Chicks - Cockerels</label>
                            <input type="number" name="live_chicks_cockerels" id="add_live_chicks_cockerels" class="form-control border-primary" min="0" value="0">
                        </div>

                        <div class="col-12 mt-4"><h6 class="fw-bold border-bottom pb-2 mb-0" style="color: #370709;"><i class="bi bi-x-circle me-2"></i>3. Total Deaths From Sexing To Issue</h6></div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold" style="color: #370709;">Deaths - Sexing Pullets</label>
                            <input type="number" name="deaths_sexing_pullets" id="add_deaths_sexing_pullets" class="form-control border-danger" min="0" value="0">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold" style="color: #370709;">Deaths - Sexing Cockerels</label>
                            <input type="number" name="deaths_sexing_cockerels" id="add_deaths_sexing_cockerels" class="form-control border-danger" min="0" value="0">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold" style="color: #370709;">Deaths - Sexing Unsexed</label>
                            <input type="number" name="deaths_sexing_unsexed" id="add_deaths_sexing_unsexed" class="form-control border-danger" min="0" value="0">
                        </div>
                        ...
                        <!-- Month Old Category -->
                        <div class="col-12 mt-3"><span class="badge bg-secondary text-light px-3 py-2 fs-6">Month Old Category</span></div>
                        <div class="col-md-4">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <textarea name="remarks" id="add_remarks" class="form-control" rows="2" placeholder="e.g. Special notes on hatchability, transport, or range distribution..."></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light">
                    <button type="button" class="btn btn-secondary fw-bold" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn text-light fw-bold" style="background-color: #a07174;">Save Issuing Summary</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="processors/chicks_issuing_crud.php" method="POST">
                ...
                <div class="modal-footer bg-light">
                    <button type="button" class="btn btn-secondary fw-bold" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn text-light fw-bold" style="background-color: #a07174;">Update Issuing Summary</button>
                </div>
            </form>
        </div>
    </div>
