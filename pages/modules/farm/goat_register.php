<?php
// pages/modules/farm/goat_register.php -> Goat (Expended/Disposal Register) Module
...
$species_type = 'Goat';
$current_page_file = 'goat_register.php';

// Auto-create database table if not exists
$create_table_sql = "CREATE TABLE IF NOT EXISTS `animal_disposal_register` (
  ...
  PRIMARY KEY (`id`),
  KEY `species_user` (`species`, `user_id`),
...
<div class="row align-items-center mb-4">
    <div class="col-md-7">
        <h3 class="fw-bold text-dark m-0">
            <i class="bi bi-journal-text me-2" style="color: #820100;"></i>Goat Expended / Disposal Register
        </h3>
        <p class="text-muted mb-0 small">Official ledger to log and track the disposal, sale, or expenditure of Goat stock.</p>
    </div>
    <div class="col-md-5 d-flex justify-content-end align-items-center gap-2">
        ...
        <button type="button" class="btn btn-sm btn-outline-secondary px-3" onclick="window.location.href='goat_register.php?month=all'">
            All
        </button>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm p-3 bg-white card-kpi-distributed" style="border-radius: 12px;">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted d-block mt-1">Goat Stock</small>
                </div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
    <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
        <h5 class="fw-bold text-dark m-0">
            <i class="bi bi-table me-2" style="color: #820100;"></i>Goat Expended / Disposal Ledger Entries
        </h5>
        <button class="btn btn-log-feed fw-bold px-4 text-light shadow-sm" style="background-color: #820100;" data-bs-toggle="modal" data-bs-target="#addAnimalDisposalModal">
            <i class="bi bi-plus-circle me-1"></i>Log Goat Disposal
        </button>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="goatDisposalTable" class="table table-bordered table-hover align-middle text-center" style="width:100%">
                <thead class="table-header-dark">
                    ...
                    <tr class="bg-light text-dark small">
                        <th style="width: 6%;">Stud Bucks</th>
                        <th style="width: 6%;">Castrated Bucks</th>
                        <th style="width: 6%;">Does</th>
                        <th style="width: 6%;">Female Kids</th>
                        <th style="width: 6%;">Male Kids</th>
                    </tr>
                </thead>
                <tbody>
...
function applyMonthFilter() {
    ...
    if (monthVal) {
        window.location.href = 'goat_register.php?month=' + monthVal;
    } else {
        window.location.href = 'goat_register.php?month=all';
    }
}
        ...
        btn.addEventListener('click', function(e) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    ...
                    text: "Are you sure you want to delete this Goat disposal record?",
                    icon: 'warning',
                ...
                if (confirm("Are you sure you want to delete this Goat disposal record?")) {
                    window.location.href = deleteUrl;
                }
            }
        });
