<?php
// pages/modules/farm/cattle_register.php -> Cattle (Expended/Disposal Register) Module
...
$species_type = 'Cattle';
$current_page_file = 'cattle_register.php';
...
<div class="row align-items-center mb-4">
    <div class="col-md-7">
        <h3 class="fw-bold text-dark m-0">
            <i class="bi bi-journal-text me-2" style="color: #820100;"></i>Cattle Expended / Disposal Register
        </h3>
        <p class="text-muted mb-0 small">Official ledger to log and track the disposal, sale, or expenditure of Cattle stock.</p>
    </div>
    <div class="col-md-5 d-flex justify-content-end align-items-center gap-2">
        ...
        <button type="button" class="btn btn-sm btn-outline-secondary px-3" onclick="window.location.href='cattle_register.php?month=all'">
            All
        </button>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm p-3 bg-white card-kpi-distributed" style="border-radius: 12px;">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted d-block mt-1">Cattle Animals</small>
                </div>
...
<div class="card border-0 shadow-sm mb-4" style="border-radius: 12px;">
    <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
        <h5 class="fw-bold text-dark m-0">
            <i class="bi bi-table me-2" style="color: #820100;"></i>Cattle Expended / Disposal Ledger Entries
        </h5>
        <button class="btn btn-log-feed fw-bold px-4 text-light shadow-sm" style="background-color: #820100;" data-bs-toggle="modal" data-bs-target="#addAnimalDisposalModal">
            <i class="bi bi-plus-circle me-1"></i>Log Cattle Disposal
        </button>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="cattleDisposalTable" class="table table-bordered table-hover align-middle text-center" style="width:100%">
                    ...
                    <?php if (empty($records)): ?>
                        <tr>
                            <td colspan="13" class="text-center py-4 text-muted">
                                ...
                                No Cattle disposal records found for the selected filter period.
                            </td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($records as $r): ?>
                            <tr>
                                ...
                                <td class="text-end text-nowrap">
                                    ...
                                    <a href="processors/animal_disposal_crud.php?action=delete&id=<?= $r['id'] ?>&redirect_page=cattle_register.php" class="btn btn-sm btn-delete-action btn-delete-record" title="Delete Record">
...
function applyMonthFilter() {
    ...
    if (monthVal) {
        window.location.href = 'cattle_register.php?month=' + monthVal;
    } else {
        window.location.href = 'cattle_register.php?month=all';
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-edit-disposal').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            // Trigger live sum update for edit modal
        ...
        btn.addEventListener('click', function(e) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    ...
                    text: "Are you sure you want to delete this Cattle disposal record? This action cannot be undone.",
                    icon: 'warning',
                ...
                if (confirm("Are you sure you want to delete this Cattle disposal record?")) {
                    window.location.href = deleteUrl;
                }
            }
        });
