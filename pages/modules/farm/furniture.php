<?php
// pages/modules/farm/furniture.php -> Furniture & Fittings Inventory Registry (Regional Farm)
...
// Fetch Furniture Assets for current Regional Farm
$stmt = $mysqli->prepare("SELECT * FROM furniture_assets WHERE (farm_id = ? OR user_id = ?) ORDER BY id DESC");
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        ...
        <p class="text-muted small mb-0">Regional Farm office desks, chairs, filing cabinets, and fittings registry</p>
    </div>
                ...
                <div class="modal-body p-4">
                    <div class="mb-3">
                        ...
                        <select name="furniture_type" class="form-select fw-bold" required>
                            ...
                            <option value="Visitor Chairs">Visitor Chairs</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="remarks" class="form-control" rows="2" placeholder="Item specs or location details..."></textarea>
                    </div>
                </div>
