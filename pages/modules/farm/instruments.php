            ...
            <form action="processors/office_assets_crud.php" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="specification" class="form-control" rows="2" placeholder="e.g. Brand, Model, Accuracy, Range..."></textarea>
                    </div>
                    <div class="mb-3">
            ...
            <form action="processors/office_assets_crud.php" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted">Initial Baseline Stock</label>
                            <input type="number" name="initial_count" id="edit_instrument_initial_count" class="form-control fw-bold" min="0" required oninput="calcEditInstrument()">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted">Received Quantity</label>
                            <input type="number" name="received_quantity" id="edit_instrument_received_quantity" class="form-control fw-bold" min="0" required oninput="calcEditInstrument()">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-bold small text-muted">Current Availability</label>
...
function calcEditInstrument() {
    const base = parseInt(document.getElementById('edit_instrument_initial_count').value) || 0;
    const recv = parseInt(document.getElementById('edit_instrument_received_quantity').value) || 0;
    document.getElementById('edit_instrument_qty').value = Math.max(0, base + recv);
}
...
document.addEventListener('DOMContentLoaded', function() {
    $(document).on('click', '.btn-edit-instrument', function() {
        ...
        $('#edit_instrument_initial_count').val(btn.data('initial_count') !== undefined ? btn.data('initial_count') : btn.data('available_quantity'));
        $('#edit_instrument_received_quantity').val(btn.data('received_quantity') !== undefined ? btn.data('received_quantity') : 0);
