                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="employment_type" id="sms_add_employment_type" class="form-select fw-bold" required onchange="toggleSmsAddEmpEmploymentStatus(this.value)">
                        ...
                        <div class="col-md-6" id="sms_add_emp_employment_status_col" style="display: block;">
                            <label class="form-label small fw-bold text-primary">
                                <i class="bi bi-briefcase-fill me-1"></i>Employment Status <span class="text-danger">*</span>
                            </label>
                            <select name="employment_status" id="sms_add_emp_employment_status" class="form-select border-primary" onchange="toggleSmsAddEmpAttachmentReason(this.value)">
                                <option value="Permanent" selected>Permanent</option>
                        ...
                        <div class="col-md-12" id="sms_add_emp_attachment_reason_col" style="display: none;">
                            ...
                            <textarea name="attachment_reason" id="sms_add_emp_attachment_reason" class="form-control border-danger" rows="2" placeholder="Specify the reason for attachment (e.g., medical reasons, maternity leave, urgent operational cover)..." disabled></textarea>
...
<script>
function toggleSmsAddEmpEmploymentStatus(empTypeValue) {
    var col = document.getElementById('sms_add_emp_employment_status_col');
    var statusSelect = document.getElementById('sms_add_emp_employment_status');
    ...
    if (empTypeValue && empTypeValue.toLowerCase() === 'permanent') {
        ...
        toggleSmsAddEmpAttachmentReason(statusSelect.value);
    } else {
        col.style.display = 'none';
        statusSelect.disabled = true;
        statusSelect.value = '';
        toggleSmsAddEmpAttachmentReason('');
    }
}

function toggleSmsAddEmpAttachmentReason(statusVal) {
    var reasonCol = document.getElementById('sms_add_emp_attachment_reason_col');
    var reasonInput = document.getElementById('sms_add_emp_attachment_reason');
