<!-- Modal 2: Edit Staff Officer Details for SMS Unit -->
<div class="modal fade" id="editEmployeeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header text-light" style="background-color: #370709;">
                <h5 class="modal-title fw-bold"><i class="bi bi-pencil-square me-2"></i>Edit Technical Officer Details</h5>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="user_role" id="edit_user_role" class="form-select fw-bold" required>
                                ...
                                <option value="employee">Technical Field Staff / Assistant</option>
