...
<script>
    ...
    function viewMachinery(data) {
        ...
        if (document.getElementById('view_machinery_received_quantity')) {
            document.getElementById('view_machinery_received_quantity').textContent = (data.received_quantity !== undefined && data.received_quantity !== null) ? data.received_quantity : 0;
        }
        ...
        if (document.getElementById('view_machinery_issue_order_no')) {
            document.getElementById('view_machinery_issue_order_no').textContent = data.issue_order_no || '-';
        }
        if (document.getElementById('view_machinery_received_from')) {
            document.getElementById('view_machinery_received_from').textContent = data.received_from || '-';
        }
        if (document.getElementById('view_machinery_receipt_no')) {
            document.getElementById('view_machinery_receipt_no').textContent = data.receipt_no || '-';
        }
        if (document.getElementById('view_machinery_specification')) {
            document.getElementById('view_machinery_specification').textContent = data.specification || '-';
        }
    ...
    function editMachinery(data) {
        ...
        if (document.getElementById('edit_machinery_received_quantity')) {
            document.getElementById('edit_machinery_received_quantity').value = (data.received_quantity !== undefined && data.received_quantity !== null) ? data.received_quantity : 0;
        }
        ...
        if (document.getElementById('edit_machinery_issue_order_no')) {
            document.getElementById('edit_machinery_issue_order_no').value = data.issue_order_no || '';
        }
        if (document.getElementById('edit_machinery_received_from')) {
            document.getElementById('edit_machinery_received_from').value = data.received_from || '';
        }
        if (document.getElementById('edit_machinery_receipt_no')) {
            document.getElementById('edit_machinery_receipt_no').value = data.receipt_no || '';
        }
        if (document.getElementById('edit_machinery_specification')) {
            document.getElementById('edit_machinery_specification').value = data.specification || '';
        }
    ...
    function calcAddMachineryAvailability() {
        var base = parseInt(document.getElementById('add_machinery_initial_count').value) || 0;
        var recv = parseInt(document.getElementById('add_machinery_received_quantity').value) || 0;
        var avail = base + recv;
        var condSelect = document.querySelector('#addMachineryForm select[name="current_condition"]');
        if (condSelect && condSelect.value === 'Damaged') {
            avail = Math.max(0, avail - 1);
        }
        document.getElementById('add_machinery_available_quantity').value = avail;
    }
    ...
    $('#addMachineryForm select[name="current_condition"]').on('change', function() {
        calcAddMachineryAvailability();
    });
