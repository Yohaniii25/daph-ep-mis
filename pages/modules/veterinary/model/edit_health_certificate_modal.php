            ...
            <form id="formEditHealthCert" action="processors/health_certificate_crud.php" method="POST">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" 
                                       ...
                                       autocomplete="off" 
                                       required>
                                <button class="btn btn-outline-secondary btn-sm" type="button" id="btn_lookup_edit_farmer_nic" title="Lookup Farmer">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-1">
                                ...
                                <span id="edit_hc_nic_status" class="badge bg-secondary-subtle text-secondary small" style="display: none;"></span>
                            </div>
                        </div>
                        ...
                        <!-- Live Farmer Details & Animal Counts Auto-Pull Card -->
                        <div class="col-12" id="edit_hc_farmer_info_card" style="display: none;">
                            <div class="p-3 rounded-3 border bg-light-subtle shadow-sm">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <small class="text-muted" id="edit_hc_farmer_reg_display"></small>
                                </div>
                                <div class="row g-2 align-items-center">
                                    <div class="col-md-12">
                                        <small class="text-muted d-block fw-semibold" style="font-size: 11px;">CURRENT REGISTERED ANIMAL POPULATION</small>
                                        <div class="d-flex flex-wrap gap-2 mt-1" id="edit_hc_animal_counts_badges">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="farm_registration_no" id="edit_farm_registration_no" class="form-control form-control-sm font-monospace">
                        </div>
                        <div class="col-md-6">
