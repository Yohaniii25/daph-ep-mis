    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header text-light py-3" style="background-color:#370709;">
                <h6 class="modal-title fw-bold" id="addAdvancedLabel"><i class="bi bi-calendar-plus me-2"></i>Add Advanced Programme</h6>
            ...
            <form id="formAddProg" action="processors/save_advanced_programme.php" method="POST">
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label small fw-bold">Programme Type</label>
                            <input type="text" name="programme_type" class="form-control form-control-sm" placeholder="e.g. Field Vaccination Drive" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold">Location</label>
                            <input type="text" name="location" class="form-control form-control-sm" placeholder="e.g. East Range Office" required>
                        </div>
                        <div class="col-md-6">
