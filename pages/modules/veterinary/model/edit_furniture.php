<!-- Premium Edit Furniture Asset Modal -->
        ...
        <div class="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
            ...
            <div class="modal-header text-white border-0 py-3 px-4" style="background: linear-gradient(135deg, #820100 0%, #4a0000 100%);">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Edit Furniture Asset Record</h5>
                        <small class="text-white-50" style="font-size: 12px;">Audited Furniture &amp; Fixture Lifecycle Tracking</small>
                    </div>
                </div>
            ...
            <!-- Form -->
            <form id="editFurnitureForm" action="processors/update_furniture.php" method="POST">
                <input type="hidden" name="id" id="edit_furniture_id">
                <input type="hidden" name="unit" id="edit_furniture_unit" value="range_veterinary_officer">
                    ...
                    <div class="card border-0 shadow-sm rounded-3 mb-3">
                        <div class="card-body p-3">
                            <h6 class="text-uppercase fw-bold text-muted small mb-3" style="letter-spacing: 0.5px;">
                                <i class="bi bi-tag-fill me-1 text-primary"></i> Furniture Specification
                            </h6>
                            <div class="row g-3">
                                <div class="col-md-7">
                                    <label class="form-label small fw-bold text-dark">
                                        Furniture Classification Type <span class="text-danger">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-easel"></i></span>
                                        <input type="text" name="furniture_type" id="edit_furniture_type" class="form-control border-start-0" placeholder="e.g. Steel Almirah, Executive Office Chair" required>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label small fw-bold text-dark">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="date_received" id="edit_date_received" class="form-control border-start-0" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="initial_count" id="edit_furniture_initial_count" class="form-control border-start-0 fw-bold fs-5 text-dark" min="0" required oninput="calcEditFurnitureAvailability()">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="received_quantity" id="edit_furniture_received_quantity" class="form-control border-start-0 fw-bold fs-5 text-success" min="0" value="0" required oninput="calcEditFurnitureAvailability()">
                                        </div>
                                        <small class="text-muted d-block mt-2" style="font-size: 11px;">
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="available_quantity" id="edit_furniture_quantity" class="form-control border-start-0 fw-bold fs-5 text-primary bg-light" readonly min="0" required>
                                        </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="current_condition" id="edit_furniture_condition" class="form-select border-start-0 shadow-none fw-semibold" required>
                                ...
                                <div class="col-md-12">
                                    <div id="edit_furniture_damaged_notice" class="alert alert-danger border-0 rounded-3 shadow-sm py-2 px-3 mt-2 d-none" style="display: none; background: #fee2e2;">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="issue_order_no" id="edit_furniture_issue_order_no" class="form-control" placeholder="e.g. IO-2024-001">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark">Received From</label>
                                    <input type="text" name="received_from" id="edit_furniture_received_from" class="form-control" placeholder="e.g. Central Provincial Stores / Donor">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark">Receipt No.</label>
                                    <input type="text" name="receipt_no" id="edit_furniture_receipt_no" class="form-control" placeholder="e.g. REC-88391">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark">Specification (Brand / Model)</label>
                                    <input type="text" name="specification" id="edit_furniture_specification" class="form-control" placeholder="e.g. Damro Steel, Godrej Model X">
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- SECTION 5: Remarks / Placement Details -->
                    <div class="card border-0 shadow-sm rounded-3">
                        <div class="card-body p-3">
                            <label class="form-label small fw-bold text-dark mb-1">
                                <i class="bi bi-geo-alt me-1 text-muted"></i>Placement Location &amp; Additional Remarks
                            </label>
                            <textarea name="remarks" id="edit_furniture_remarks" class="form-control shadow-none" rows="2" placeholder="Placement room, assigned officer, condition details..."></textarea>
                        </div>
                    </div>
                </div>
...
<script>
function calcEditFurnitureAvailability() {
    var base = parseInt(document.getElementById('edit_furniture_initial_count').value) || 0;
    var recv = parseInt(document.getElementById('edit_furniture_received_quantity').value) || 0;
    var avail = base + recv;
    var cond = document.getElementById('edit_furniture_condition').value;
    if (cond === 'Damaged') {
        avail = Math.max(0, avail - 1);
    }
    document.getElementById('edit_furniture_quantity').value = avail;
}
</script>
