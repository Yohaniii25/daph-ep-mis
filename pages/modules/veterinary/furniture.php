                            ...
                            <tr id="furniture-row-<?= $row['id'] ?>">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-sm btn-outline-warning text-dark me-1" title="Initiate Inter-Unit Transfer" onclick='openInventoryTransferModal(<?= json_encode($row) ?>, "furniture")'>
...
<script>
    ...
    function openInventoryTransferModal(data, assetType) {
        ...
        var normalizedType = assetMap[assetType] || assetType || 'furniture';
        ...
        var itemName = data.furniture_type || data.furniture_name || '-';
