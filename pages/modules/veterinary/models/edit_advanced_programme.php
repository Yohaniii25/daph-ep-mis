    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header text-white py-3" style="background-color:#a07174;">
                <h6 class="modal-title fw-bold" id="editAdvancedLabel"><i class="bi bi-pencil-square me-2"></i>Edit Advanced Programme</h6>
            ...
            <form id="formEditProg" action="processors/update_advanced_programme.php" method="POST">
                ...
                <div class="modal-footer py-2 bg-light border-0">
                    ...
                    <button type="submit" class="btn btn-sm text-white fw-bold" style="background-color:#a07174;"><i class="bi bi-save me-1"></i>Update Programme</button>
                </div>
            </form>
        </div>
    </div>
