    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header text-white" style="background-color: #e67e22;">
                <h5 class="modal-title"><i class="bi bi-pencil-square me-2"></i>Edit Counterfoil Book Record</h5>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <select name="unit" id="edit_counterfoil_unit" class="form-select" required>
                        ...
                        <div class="col-md-12">
                            <label class="form-label small fw-bold">Counterfoil Type</label>
                            <input type="text" name="counterfoil_type" id="edit_counterfoil_type" class="form-control" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label small fw-bold">Condition / Status</label>
                            <select name="current_condition" id="edit_counterfoil_condition" class="form-select" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" name="available_quantity" id="edit_counterfoil_quantity" class="form-control" min="1" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label small fw-bold">Date Received / Purchased</label>
                            <input type="date" name="purchase_date" id="edit_counterfoil_purchase_date" class="form-control" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label small fw-bold">Remarks / Serial Numbers</label>
                            <textarea name="remarks" id="edit_counterfoil_remarks" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-light">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn text-white" style="background-color: #e67e22;">Update Record</button>
                </div>
            </form>
        </div>
    </div>
