                                ...
                                <div class="col-md-6">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="number" name="initial_count" id="edit_instrument_initial_count" class="form-control border-start-0 fw-bold fs-5 text-dark" min="0" required>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="number" name="available_quantity" id="edit_instrument_quantity" class="form-control border-start-0 fw-bold fs-5 text-primary" min="0" required>
                                        </div>
                                        <small class="text-muted d-block mt-2" style="font-size: 11px;">
