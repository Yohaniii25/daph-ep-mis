    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header text-white" style="background-color: #a07174;">
                <h5 class="modal-title"><i class="bi bi-pencil-square me-2"></i>Edit Furniture Asset Log</h5>
            ...
            <form id="editFurnitureForm" action="processors/update_furniture.php" method="POST">
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" class="btn text-white" style="background-color: #a07174;">Update Asset Item</button>
                </div>
            </form>
        </div>
    </div>
