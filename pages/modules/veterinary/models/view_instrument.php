<div class="modal fade" id="viewInstrumentModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header text-light" style="background-color: #003ddc;">
                <h5 class="modal-title"><i class="bi bi-tools me-2"></i>Instrument Asset Details</h5>
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <span class="text-secondary" id="view_instrument_remarks">-</span>
                    </div>
                </div>
            </div>
