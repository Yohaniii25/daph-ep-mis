<div class="modal fade" id="viewFurnitureModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header text-white" style="background-color: #a07174;">
                <h5 class="modal-title"><i class="bi bi-file-earmark-text me-2"></i>Furniture Asset Details</h5>
            ...
            <div class="modal-body p-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <span class="fw-semibold text-secondary" id="view_date_received">-</span>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <span class="text-secondary" id="view_furniture_remarks">-</span>
                    </div>
                </div>
            </div>
