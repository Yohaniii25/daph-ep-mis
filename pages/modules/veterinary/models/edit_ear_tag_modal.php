<div class="modal fade" id="editEarTagModal" tabindex="-1" aria-labelledby="editEarTagLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header text-light py-3" style="background-color:#370709;">
                <h6 class="modal-title fw-bold" id="editEarTagLabel"><i class="bi bi-pencil-square me-2"></i>Edit Ear Tag Returns</h6>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <form id="formEditEarTag" action="processors/ear_tag_crud.php" method="POST">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="opening_balance" id="edit_opening_balance" class="form-control form-control-sm ear-calc-trigger" min="0" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-bold text-success">Received Qty (During Month)</label>
                            <input type="number" name="received_qty" id="edit_received_qty" class="form-control form-control-sm ear-calc-trigger" min="0" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small fw-bold text-info">Used Qty</label>
                            <input type="number" name="used_qty" id="edit_used_qty" class="form-control form-control-sm ear-calc-trigger" min="0" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small fw-bold text-warning">Spoilt/Damaged Qty</label>
                            <input type="number" name="spoilt_qty" id="edit_spoilt_qty" class="form-control form-control-sm ear-calc-trigger" min="0" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small fw-bold text-danger">Transferred Qty</label>
                            <input type="number" name="transferred_qty" id="edit_transferred_qty" class="form-control form-control-sm ear-calc-trigger" min="0" required>
                        </div>
