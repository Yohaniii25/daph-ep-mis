<!-- Premium Edit Machinery Asset Modal -->
        ...
        <div class="modal-content rounded-4 border-0 shadow-lg overflow-hidden">
            ...
            <div class="modal-header text-white border-0 py-3 px-4" style="background: linear-gradient(135deg, #820100 0%, #4a0000 100%);">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0">Edit Machinery Asset Record</h5>
                        <small class="text-white-50" style="font-size: 12px;">Audited Plant, Machinery &amp; Equipment Management</small>
                    </div>
                </div>
            ...
            <form id="editMachineryForm" action="processors/update_machinery.php" method="POST">
                ...
                <input type="hidden" name="unit" id="edit_machinery_unit" value="range_veterinary_officer">
                ...
                <div class="modal-body p-4 bg-light-subtle">
                    ...
                    <div class="card border-0 shadow-sm rounded-3 mb-3">
                        <div class="card-body p-3">
                            <h6 class="text-uppercase fw-bold text-muted small mb-3" style="letter-spacing: 0.5px;">
                                <i class="bi bi-tag-fill me-1 text-primary"></i> Machinery Specification
                            </h6>
                            <div class="row g-3">
                                <div class="col-md-7">
                                    <label class="form-label small fw-bold text-dark">
                                        Machinery Classification / Model <span class="text-danger">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-cpu"></i></span>
                                        <input type="text" name="machinery_type" id="edit_machinery_type" class="form-control border-start-0" placeholder="e.g. Liquid Nitrogen Tank, Autoclave, Generator" required>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label small fw-bold text-dark">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="purchase_date" id="edit_machinery_purchase_date" class="form-control border-start-0" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="initial_count" id="edit_machinery_initial_count" class="form-control border-start-0 fw-bold fs-5 text-dark" min="0" required oninput="calcEditMachineryAvailability()">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="received_quantity" id="edit_machinery_received_quantity" class="form-control border-start-0 fw-bold fs-5 text-success" min="0" value="0" required oninput="calcEditMachineryAvailability()">
                                        </div>
                                        <small class="text-muted d-block mt-2" style="font-size: 11px;">
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="available_quantity" id="edit_machinery_quantity" class="form-control border-start-0 fw-bold fs-5 text-primary bg-light" readonly min="0" required>
                                        </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-3 mb-3">
                        <div class="card-body p-3">
                            <h6 class="text-uppercase fw-bold text-muted small mb-3" style="letter-spacing: 0.5px;">
                                <i class="bi bi-shield-check me-1 text-danger"></i> Operational Status
                            </h6>
                            <div class="row g-2">
                                <div class="col-md-12">
                                    <label class="form-label small fw-bold text-dark">
                                        Equipment Condition <span class="text-danger">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-activity"></i></span>
                                        <select name="current_condition" id="edit_machinery_condition" class="form-select border-start-0 shadow-none fw-semibold" required>
                                            <option value="Good" class="text-success fw-bold">&#9679; Good (Fully Operational)</option>
                                            <option value="Fair" class="text-warning fw-bold">&#9679; Fair (Minor Wear / Operational)</option>
                                ...
                                <div class="col-md-12">
                                    <div id="edit_machinery_damaged_notice" class="alert alert-danger border-0 rounded-3 shadow-sm py-2 px-3 mt-2 d-none" style="display: none; background: #fee2e2;">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="issue_order_no" id="edit_machinery_issue_order_no" class="form-control" placeholder="e.g. IO-2024-001">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark">Received From</label>
                                    <input type="text" name="received_from" id="edit_machinery_received_from" class="form-control" placeholder="e.g. Central Provincial Stores / Supplier">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark">Receipt No.</label>
                                    <input type="text" name="receipt_no" id="edit_machinery_receipt_no" class="form-control" placeholder="e.g. REC-10293">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark">Specification (Brand / Model)</label>
                                    <input type="text" name="specification" id="edit_machinery_specification" class="form-control" placeholder="e.g. Model X, Brand Y">
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- SECTION 5: Remarks / Maintenance Notes -->
                    <div class="card border-0 shadow-sm rounded-3">
                        <div class="card-body p-3">
                            <label class="form-label small fw-bold text-dark mb-1">
                                <i class="bi bi-wrench me-1 text-muted"></i>Service History &amp; Remarks
                            </label>
                            <textarea name="remarks" id="edit_machinery_remarks" class="form-control shadow-none" rows="2" placeholder="Serial numbers, warranty status, maintenance history..."></textarea>
                        </div>
                    </div>
                </div>
...
<script>
function calcEditMachineryAvailability() {
    var base = parseInt(document.getElementById('edit_machinery_initial_count').value) || 0;
    var recv = parseInt(document.getElementById('edit_machinery_received_quantity').value) || 0;
    var avail = base + recv;
    var cond = document.getElementById('edit_machinery_condition').value;
    if (cond === 'Damaged') {
        avail = Math.max(0, avail - 1);
    }
    document.getElementById('edit_machinery_quantity').value = avail;
}
</script>
