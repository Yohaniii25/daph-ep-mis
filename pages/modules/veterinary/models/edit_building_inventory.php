                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-dark">
                                        Inventory Number <span class="text-danger">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-hash"></i></span>
                                        <input type="text" name="inventory_number" id="edit_inventory_number" class="form-control border-start-0" placeholder="e.g. INV-2026-001" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                     <label class="form-label small fw-bold text-dark">
                                     ...
                                     <input type="text" name="inventory_type" id="edit_inventory_type" class="form-control" list="edit_inventory_type_list" placeholder="e.g. Equipment, Furniture" autocomplete="off" required>
                                     <datalist id="edit_inventory_type_list">
                                         <?php 
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="location" id="edit_inventory_location" class="form-control border-start-0" list="edit_location_datalist" placeholder="Office / Quarters" required>
                                        <datalist id="edit_location_datalist">
                                            <option value="Office">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="issue_order_no" id="edit_issue_order_no" class="form-control" placeholder="e.g. IO-2026-004">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-dark">Received From</label>
                                    <input type="text" name="received_from" id="edit_received_from" class="form-control" placeholder="e.g. Provincial Medical Stores">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold text-dark">Receipt No.</label>
                                    <input type="text" name="receipt_no" id="edit_receipt_no" class="form-control" placeholder="e.g. REC-9821">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label small fw-bold text-dark">Specification / Remarks (Brand, Model, Specs)</label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-card-text"></i></span>
                                        <input type="text" name="specification" id="edit_specification" class="form-control border-start-0" placeholder="e.g. Brand: Panasonic, Model: CS-1800, Inverter 18000 BTU">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="initial_count" id="edit_initial_count" class="form-control border-start-0 fw-bold fs-5 text-dark" min="0" required oninput="calcEditAvailability()">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="received_quantity" id="edit_received_quantity" class="form-control border-start-0 fw-bold fs-5 text-success" min="0" value="0" required oninput="calcEditAvailability()">
                                        </div>
                                        <small class="text-muted d-block mt-2" style="font-size: 11px;">
                                ...
                                <div class="col-md-4">
                                    <div class="p-3 rounded-3 border bg-white h-100 position-relative">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="available_quantity" id="edit_available_quantity" class="form-control border-start-0 fw-bold fs-5 text-primary bg-light" readonly min="0" required>
                                        </div>
...
function calcEditAvailability() {
    ...
    var avail = base + recv;
    var cond = document.getElementById('edit_current_condition').value;
    if (cond === 'Damaged') {
        avail = Math.max(0, avail - 1);
    }
    document.getElementById('edit_available_quantity').value = avail;
}
</script>
