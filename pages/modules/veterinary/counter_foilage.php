...
<script>
    ...
    function editCounterfoil(data) {
        ...
        originalCounterfoilQty = parseInt(data.available_quantity) || 1;
        originalCounterfoilCondition = data.current_condition || 'Good';

        document.getElementById('edit_counterfoil_quantity').value = originalCounterfoilQty;
    ...
    $('#edit_counterfoil_condition').on('change', function() {
        ...
        var noticeEl = document.getElementById('edit_counterfoil_damaged_notice');
        var qtyInput = document.getElementById('edit_counterfoil_quantity');
        ...
        if (selectedCond === 'Damaged') {
            ...
            if (qtyInput && originalCounterfoilCondition !== 'Damaged') {
                qtyInput.value = Math.max(0, originalCounterfoilQty - 1);
            }
        } else {
            if (noticeEl) {
                noticeEl.classList.add('d-none');
            ...
            if (qtyInput && originalCounterfoilCondition !== 'Damaged') {
                qtyInput.value = originalCounterfoilQty;
            }
        }
    });
