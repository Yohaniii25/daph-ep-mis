...
// 4. Fetch Daily Diary tasks from DB
$user_id = $_SESSION['user_id'] ?? null;
$programmes = [];
if ($user_id) {
    $stmt = $mysqli->prepare("SELECT id, task_date AS date, activity AS task, place, time_duration FROM diary_tasks WHERE user_id = ? AND YEAR(task_date) = ? ORDER BY date DESC");
                ...
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-3">
                    ...
                    <div class="col">
                        <button type="button" class="btn w-100 h-100 py-3 text-light border-0 shadow-sm d-flex flex-column align-items-center justify-content-center" style="background-color: #820100; min-height: 105px;" data-bs-toggle="modal" data-bs-target="#addDailyDiaryModal">
                            ...
                            <span class="text-center">Add Daily Diary Programme</span>
                        </button>
                    </div>
